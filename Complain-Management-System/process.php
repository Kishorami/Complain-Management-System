...
$action = isset($_GET['action']) ? $_GET['action'] : '';  //getting the required action the user has posted in different pages
...
switch ($action) {
	...
	case 'addCust' :
		addCust();  //If  I came from addCust page. Then this method will be called.
	break;
