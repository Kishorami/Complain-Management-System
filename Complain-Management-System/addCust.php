...
<h3>Add New Emplyee Details - Admin PAGE</h3>
<!--here I am adding a new employee -->
<form action="process.php?action=addCust" method="post"  name="frmListUser" id="frmListUser">  <!-- This form submits the name of the customers means adding new customers -->
  <table width="800" border="1" align="left" cellpadding="5" cellspacing="1" bgcolor="#fffff" class="entryTable">
    ...
    <tr>
      <td class="contentArea"><div class="errorMessage" align="center"><?php //echo $errorMessage; ?></div>
          <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
            ...
            <tr>
              <td>&nbsp;</td> <!--after clicking the button submit it validates the form -->
